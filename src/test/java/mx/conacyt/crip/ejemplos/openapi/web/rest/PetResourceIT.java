...
class PetResourceIT {
    ...
    public static Pet createEntity(EntityManager em) {
        Pet pet = new Pet().name(DEFAULT_NAME).status(DEFAULT_STATUS);
        return pet;
    }
    ...
    public static Pet createUpdatedEntity(EntityManager em) {
        Pet pet = new Pet().name(UPDATED_NAME).status(UPDATED_STATUS);
        return pet;
    }
    ...
    void putNewPet() throws Exception {
        ...
        updatedPet.name(UPDATED_NAME).status(UPDATED_STATUS);
    ...
    void fullUpdatePetWithPatch() throws Exception {
        ...
        partialUpdatedPet.name(UPDATED_NAME).status(UPDATED_STATUS);
