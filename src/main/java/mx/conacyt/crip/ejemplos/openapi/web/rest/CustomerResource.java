...
import mx.conacyt.crip.ejemplos.openapi.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link mx.conacyt.crip.ejemplos.openapi.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
