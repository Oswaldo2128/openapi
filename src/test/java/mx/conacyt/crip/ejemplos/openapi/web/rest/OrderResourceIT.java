...
import mx.conacyt.crip.ejemplos.openapi.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    private static final Instant DEFAULT_SHUP_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_SHUP_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().quantity(DEFAULT_QUANTITY).shupDate(DEFAULT_SHUP_DATE).status(DEFAULT_STATUS).complete(DEFAULT_COMPLETE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().quantity(UPDATED_QUANTITY).shupDate(UPDATED_SHUP_DATE).status(UPDATED_STATUS).complete(UPDATED_COMPLETE);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getShupDate()).isEqualTo(DEFAULT_SHUP_DATE);
        assertThat(testOrder.getStatus()).isEqualTo(DEFAULT_STATUS);
        assertThat(testOrder.getComplete()).isEqualTo(DEFAULT_COMPLETE);
    }
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].shupDate").value(hasItem(DEFAULT_SHUP_DATE.toString())))
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.shupDate").value(DEFAULT_SHUP_DATE.toString()))
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.quantity(UPDATED_QUANTITY).shupDate(UPDATED_SHUP_DATE).status(UPDATED_STATUS).complete(UPDATED_COMPLETE);
        ...
        assertThat(testOrder.getShupDate()).isEqualTo(UPDATED_SHUP_DATE);
        assertThat(testOrder.getStatus()).isEqualTo(UPDATED_STATUS);
        assertThat(testOrder.getComplete()).isEqualTo(UPDATED_COMPLETE);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.quantity(UPDATED_QUANTITY).status(UPDATED_STATUS).complete(UPDATED_COMPLETE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.quantity(UPDATED_QUANTITY).shupDate(UPDATED_SHUP_DATE).status(UPDATED_STATUS).complete(UPDATED_COMPLETE);
