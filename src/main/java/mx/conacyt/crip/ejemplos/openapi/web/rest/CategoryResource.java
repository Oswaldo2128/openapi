...
import mx.conacyt.crip.ejemplos.openapi.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link mx.conacyt.crip.ejemplos.openapi.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
